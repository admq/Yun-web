 ...
 * JS files.  The build filesystem is supposed to remove log statements
...
/**
 * Write a filesystem message.  This message will be preserved in the
...
Y.Loader.prototype = {
    ...
    */
    ...
    /**
    * Adds an alias module to the filesystem
    * @method addAlias
